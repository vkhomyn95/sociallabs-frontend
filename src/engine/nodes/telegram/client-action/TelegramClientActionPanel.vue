...
import { defaultTelegramClientActionParams, type TelegramClientActionParams } from './index'
import ClientActionMessageTab from './components/TelegramClientActionMessageTab.vue'
import ClientActionKeyboardTab from './components/TelegramClientActionKeyboardTab.vue'
import ClientActionOptionsTab from './components/TelegramClientActionOptionsTab.vue'
...
const params = reactive<TelegramClientActionParams>({
  ...defaultTelegramClientActionParams(),
...
function patchParams(patch: Partial<TelegramClientActionParams>) {
