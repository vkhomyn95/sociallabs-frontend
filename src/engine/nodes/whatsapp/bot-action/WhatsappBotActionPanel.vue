...
import { defaultWhatsAppActionParams, type WhatsAppActionParams } from './index'
import ActionMessageTab from './components/WhatsappBotActionMessageTab.vue'
import ActionOptionsTab from './components/WhatsappBotActionOptionsTab.vue'
...
const params = reactive<WhatsAppActionParams>({
  ...defaultWhatsAppActionParams(),
...
function patchParams(patch: Partial<WhatsAppActionParams>) {
