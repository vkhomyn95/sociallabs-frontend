...
import { defaultWhatsAppTriggerParams, type WhatsAppTriggerParams } from './index'
import TriggerEventsTab  from './components/WhatsappBotTriggerEventsTab.vue'
import TriggerOptionsTab from './components/WhatsappBotTriggerOptionsTab.vue'
...
const params = reactive<WhatsAppTriggerParams>({
  ...defaultWhatsAppTriggerParams(),
...
function patchParams(patch: Partial<WhatsAppTriggerParams>) {
